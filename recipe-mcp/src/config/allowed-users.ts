 ...
 *
 * Maps email addresses to database user IDs
 */

export const USER_CONFIG: Record<string, string> = {
  "leonchike@gmail.com": "clzej3dqz0000inntk5x0bqre",
  "leonnwankwo@gmail.com": "clzej3dqz0000inntk5x0bqre",
};
...
/**
 * Resolve a database user ID from an authenticated email address
 */
export function resolveUserId(email: string): string | null {
