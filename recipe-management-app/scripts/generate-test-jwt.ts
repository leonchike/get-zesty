...
if (args.length < 2) {
  console.error("Usage: ts-node generate-test-jwt.ts <userId> <email> [name]");
  console.error("Example: ts-node generate-test-jwt.ts clzefyp8z0000gdusw0ii4med user@example.com 'John Doe'");
  process.exit(1);
}
